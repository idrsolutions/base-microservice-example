 ...
 * <pre>
 * &#64;WebServlet("/media/*")
 * public class MediaFileServlet extends DefaultFileServlet {
 *
 *     private File folder;
 *
 *     &#64;Override
 ...
 * </pre>
 *
 * <h3>Customizing <code>DefaultFileServlet</code></h3>
 * <p>
 ...
 * @since 2.2
 */
public abstract class DefaultFileServlet extends HttpServlet {

    // Constants ------------------------------------------------------------------------------------------------------

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(DefaultFileServlet.class.getName());
